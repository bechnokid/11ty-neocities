...
{% figure "20230125_amiibo.jpg", { bg: true, class: 'landscape' } %} Various amiibos. Left to right: Callie (Splatoon), Malzeno (Monster Hunter Rise: Sunbreak), Marie (Splatoon). I'm so glad to finally own these amiibos! {% endfigure %}
{% figure "20230125_merch.jpg", { bg: true, class: 'bg-center' } %} Left to right, top to bottom: ["Cinnamon Roll Icing" slime](https://www.etsy.com/shop/WizardSlymes), [Cat!Doctor Strange keychain](https://deviantart.com/view/705315509), Vash keychain (Trigun), [phở enamel pin](https://www.nomsco.com/collections/pins-1/products/pho-enamel-pin) {% endfigure %}
</div>
...
<div class="blog-gallery">
{% figure "20230125_cultofthelamb.jpg", { bg: true, class: 'landscape' } %}Cult of the Lamb{% endfigure %}
{% figure "20230125_bizu.jpg", { bg: true } %} Bizu-Kun ([SNOBBISM](https://youtu.be/f5jDVFmEIVQ)) {% endfigure %}
{% figure "20230125_odette.jpg", { bg: true } %} Odette (Swan Princess) {% endfigure %}
{% figure "20230125_narga.jpg", { bg: true } %} Hunter in Nargacuga armor (Monster Hunter World) {% endfigure %}
</div>
...
<div class="blog-gallery">
{% figure "20230125_same.jpg", { bg: true } %} Found one other person wearing the same jacket as me! (bottom right is me) {% endfigure %}
{% figure "20230125_bear.jpg", { bg: true, class: 'bg-center' } %} Monobear sitting on a Star Wars throne. Yes, he's wearing a mask! {% endfigure %}
</div>