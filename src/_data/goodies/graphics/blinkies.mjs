export default {
  ...
  collection: {
    ...
    {
      src: "artist.gif",
      alt: "A black blinkie with a red and white dashed border with rainbow text that reads in capital letters, \"Artist\". The text is surrounded by a comedy mask, an artist's palette, some rainbow paint splatters, and two white music notes"
    },
    {
      src: "antique.gif",
