export default {
  imgSrc: "/assets/images/goodies/site/",
  title: "88 x 31 Buttons",
  template:
  {
    src: "",
    alt: ""
  ...
  collection: {
    items: [
      {
        src: "ai-theft.gif",
        alt: "A button that says, \"AI is theft, not art!\", with the letters \"AI\" crossed out."
      },
      {
        src: "no-hotlinks.png",
        alt: "A button that says, \"Campaign against hotlinks!\" with an image of a chain link on fire being crossed out.",
        freezeframe: true
      },
      {
        src: "righttorepair.png",
        alt: "A blue button that says in white text, \"I support the right to repair\" with an image of a hand holding a wrench next to it."
      },
      {
        src: "transrights.png",
        alt: "A button that says \"Trans rights now!\" with an image of the transgender flag next to it."
      },
      {
        src: "antinft.gif",
        alt: "A button that says, \"This is an Anti-NFT site\" with an crossed-out image of a server and an NFT on fire."
      },
      {
        src: "antinazi.gif",
        alt: "A button that says, \"No Nazi, no fascism, no racism\" with an image of the swastika crossed out."
      },
      {
        src: "gay-rights.png",
        alt: "A button that consists of the rainbow flag",
        url: "https://zeusofthecrows.tumblr.com/post/709307184195010560"
      },
      {
        src: "2020SUCKS.png",
        alt: "A dark button with white text that reads, \"social distancing survivor 2020\"."
      },
      {
        src: "blockads.gif",
        alt: "A blue button with text that reads, \"Blocking ads is blocking spyware. Blocking ads is blocking annoyances. Blocking ads is blocking malware. Don't want your ads blocked? Then stop being creepying, annoying, and malicious.\""
      },
      {
        src: "youmad.gif",
      ...
      {
        src: "windows-xp.gif",
        alt: "A button that resembles the top window bar from Windows XP",
        url: "https://zeusofthecrows.tumblr.com/post/709307184195010560"
      },
      {
      ...
      {
        src: "salmon-run.png",
        alt: "An orange button with the black logo of Grizzco from Splatoon",
        url: "https://lollich0p.tumblr.com/tagged/88x31"
      },
      {
        src: "SA2BATTLE.png",
        alt: "A button that depicts the logo from Sonic Adventure 2 Battle. Behind the logo are Sonic the Hedgehog and Shadow the Hedgehog"
      },
      {
        src: "rewind.gif",
        alt: "An animated button that depicts an image of a grassy field against a blue sky reminiscent of the Windows XP wallpaper with the text REW above it. The button has a static-y filter",
        url: "https://zeusofthecrows.tumblr.com/post/695189042788253696",
        freezeframe: true
      },
      {
        src: "pokemon.gif",
        alt: "An animated button that shows the Pokemon logo with Pikachu running on the side",
        freezeframe: true
      },
      {
        src: "not-alone.gif",
      ...
      {
        src: "nichijou.gif",
        alt: "An animated button of a scene from Nichijou with a masked high schoool student chasing after a distressed Mio",
        url: "https://zanarkand.neocities.org/withlove",
        freezeframe: true
      },
      {
        src: "naptime.png",
      ...
      {
        src: "krak-on.png",
        alt: "A button with the Krak-on brand logo from the Splatoon franchise",
        url: "https://lollich0p.tumblr.com/tagged/88x31"
      },
      {
        src: "keyboard.gif",
        alt: "An animated button that consists of keys from a keyboard",
        url: "https://zeusofthecrows.tumblr.com/post/709503504879878144",
        freezeframe: true
      },
      {
        src: "jojo-micro-bar.png",
        alt: "A button with a pixelated version of the logo from Jojo's Bizarre Adventure"
      },
      {
        src: "hello_kitty.gif",
      ...
      {
        src: "caramelldansen.gif",
        alt: "An animated GIF of two girls dancing the Caramelldansen dance",
        freezeframe: true
      },
      {
        src: "calneca.gif",
        alt: "A flashing image of Calne Ca",
        url: "https://plasticdino.net/graphics",
        freezeframe: true
      },
      {
        src: "albutton.png",
  ...
  mine: {
    ...
    items: [
      {
        src: "mh_vs_izuchi.gif",
        alt: "An animated button from Monster Hunter Rise of a crudely drawn hunter sitting on top of a Palamute that is hitting a Great Izuchi",
        freezeframe: true
      },
      {
      ...
      },
      {
        ...
        alt: "An animated button of a hunter cooking a piece of meat over a fire using a BBQ spit",
        freezeframe: true
      },
      {
        src: "mh_malzeno2.gif",
        alt: "An animated button of Malzeno, a monster from Monster Hunter Rise: Sunbreak. It is looming towards its prey",
        freezeframe: true
      },
      {
        src: "mh_malzeno.gif",
        alt: "An animated button of Malzeno, a monster from Monster Hunter Rise: Sunbreak. It is spreading its wings",
        freezeframe: true
      },
      {
        src: "mh_lea.gif",
      ...
      {
        src: "mh_deviljho.gif",
        alt: "An animated button from NCH Productions' video of a cartoony Deviljho, a monster from Monster Hunter, quickly transitioning into a more realistic Deviljho",
        url: "https://www.youtube.com/c/NCHProductions",
        freezeframe: true
      },
      {
        src: "mh_deviljho_meat.gif",
        alt: "An animated button from NCH Productions' video of a cartoony Deviljho, a monster from Monster Hunter, dancing with two pieces of Drugged Meat",
        url: "https://www.youtube.com/c/NCHProductions",
        freezeframe: true
      },
      {
        src: "mh_deviljho_dance.gif",
        alt: "An animated button from NCH Productions' video of a cartoony Deviljho, a monster from Monster Hunter, dancing",
        url: "https://www.youtube.com/c/NCHProductions",
        freezeframe: true
      },
      {
