...
<div class='col-12 col-lg-4 mb-3 mb-lg-0'>
{% galleryBox { markdown: true, title: "Likes", cls: 'h-100' } %}
- Drawing
- Crocheting
- Rice
- Bún bò Huế
...
{% galleryBox { markdown: true, title: "Media I Like", cls: 'h-100' } %}
- **Monster Hunter**
- Tamagotchi
- Digimon
- Kill la Kill
